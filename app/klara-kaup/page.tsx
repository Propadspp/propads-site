      ...
      <main style={{ maxWidth: 1100, margin: '0 auto', padding: '120px 24px 80px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 420px', gap: 48, alignItems: 'start' }}>
          <form onSubmit={handleSubmit}>
            <div style={{ background: '#101010', border: '1px solid rgba(255,255,255,0.07)', borderRadius: 20, padding: 32, marginBottom: 20 }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 14 }}>
                  <div><label className="form-label" style={{ display: 'block', fontSize: '0.8125rem', fontWeight: 500, color: 'rgba(255,255,255,0.55)', marginBottom: 8 }}>Fornafn</label><input name="fornafn" type="text" required placeholder="Jón" className="form-input" /></div>
                  <div><label className="form-label" style={{ display: 'block', fontSize: '0.8125rem', fontWeight: 500, color: 'rgba(255,255,255,0.55)', marginBottom: 8 }}>Eftirnafn</label><input name="eftirnafn" type="text" required placeholder="Sigurðsson" className="form-input" /></div>
                </div>
            ...
            <div style={{ background: '#101010', border: '1px solid rgba(255,255,255,0.07)', borderRadius: 20, padding: 32, marginBottom: 32 }}>
